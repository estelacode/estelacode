# 📚 AI Engineering & Data Science Tech Blogs
...
*   **Eugene Yan**
    *   **Description:** Deep dives into LLMs in production, agent design patterns, and building large-scale AI systems without the hype.
    *   **Key Topics:** #LLMOps, #AI-Agents, #SystemDesign
    *   **URL:** [https://eugeneyan.com](https://eugeneyan.com)
*   **Chip Huyen**
    *   **Description:** Author of *Designing Machine Learning Systems*. Focuses on ML infrastructure, vector databases, and cost optimization.
    *   **Key Topics:** #MLOps, #VectorDB, #Infrastructure
    *   **URL:** [https://huyenchip.com](https://huyenchip.com)
*   **Sebastian Raschka**
    *   **Description:** Highly technical guides on training, optimizing, and fine-tuning modern open-source language models.
    *   **Key Topics:** #FineTuning, #DeepLearning, #LLMs
    *   **URL:** [https://sebastianraschka.com](https://sebastianraschka.com)
*   **Hamel Husain**
    *   **Description:** Specialist in LLM evaluation, robust data pipelines, and predictable fine-tuning strategies.
